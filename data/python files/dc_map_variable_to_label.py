...
# Paths
input_csv = r'C:\Users\jchen\YouthEmploymentEducationProject\data\democracy_checkup_variables.csv'
output_json = 'data/democracy_checkup_labels.json'
unfilled_output = 'data/unlabeled_democracy_checkup_labels.json'

# Load variable names from CSV (no header)
variable_names = []
with open(input_csv, newline='', encoding='utf-8') as csvfile:
    reader = csv.reader(csvfile)
    for row in reader:
        variable_names.append(row[0])  # each row is a single-element list
