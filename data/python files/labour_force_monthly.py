...
df = pd.read_csv("data\labour_force_by_agegroup_monthly_july2025.csv")
...
df_filtered.to_json("react-d3\public\cleaned_labour_data_monthly_july2025.json", orient="records", indent=2)